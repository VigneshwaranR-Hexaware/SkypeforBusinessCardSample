...
Marketplace
Gist
 @VigneshwaranR-Hexaware
 Sign out
 Watch 0
  Star 0
  Fork 0 pourabkarchaudhuri/citi-sfb-nodejs
 Code  Issues 0  Pull requests 0  Projects 0  Wiki Insights 
Branch: master Find file Copy pathciti-sfb-nodejs/app.js
2774507  on Jun 20
 hexinnov Minor Corrections
0 contributors
RawBlameHistory     
494 lines (396 sloc)  23.6 KB
      ...
      intents.matches('FullReportRequestIntent', [
                    function (session, args) {
                       ...
                       console.log("Args : "+JSON.stringify(args));
                        ...
                        //var responseString="Click on the Button to get Full Report.<br><input value=\"View Report\" name=\"btn1\" type=\"button\" />"
                        session.send(responseString);
